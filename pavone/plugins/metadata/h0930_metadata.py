...
参考: D:\\code\\metatube-sdk-go-main\\provider\\h0930\\h0930.go
      D:\\code\\metatube-sdk-go-main\\provider\\h0930\\core\\core.go
支持的 URL 模式: https://www.h0930.com/moviepages/{movie_id}/index.html
与 C0930 共享同一套 core 解析逻辑（JSON-LD + dl/dt/dd）。
"""
...
PLUGIN_NAME = "H0930Metadata"
PLUGIN_VERSION = "1.0.0"
PLUGIN_DESCRIPTION = "提取 h0930.com 的视频元数据"
PLUGIN_AUTHOR = "PAVOne"
PLUGIN_PRIORITY = 50

SUPPORTED_DOMAINS = ["h0930.com", "www.h0930.com"]
SITE_NAME = "H0930"
DEFAULT_MAKER = "エッチな0930"

MOVIE_URL_TEMPLATE = "https://www.h0930.com/moviepages/{movie_id}/index.html"
MOVIE_ID_RE = re.compile(r"^(?:h0930[-_])?([a-z\d]+)$", re.IGNORECASE)


class H0930Metadata(JsonLdMetadataPlugin):
    """h0930.com 元数据提取器（与 C0930 同一 core 结构）。"""
