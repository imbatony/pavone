...
class TestJTableExtractor(unittest.TestCase):
    ...
    def test_extract_tags(self):
        ...
        expected_tags = ['少女', 'パンスト', '3P', '痴女', '黒ストッキング', '調教・奴隷', '美脚', '辱め', 'キス', 'ガーターベルト', 'ラブポーション', '男M', '捜査官']
    ...
    def test_extract_success(self, mock_fetch):
        ...
        main_item = result[0]
        self.assertEqual(main_item.get_url(), "https://gmas-clena.mushroomtrack.com/hls/bXNwsqF7g4nB5Wr29gK2DA/1750698775/36000/36865/36865.m3u8")
        ...
        if cover_item:
            self.assertEqual(cover_item.get_url(), "https://assets-cdn.jable.tv/contents/videos_screenshots/36000/36865/preview.jpg")
