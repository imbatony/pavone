...
class TestHTTPDownloader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = DownloadConfig(output_dir=self.temp_dir)
    ...
    def test_init(self):
        ...
        self.assertEqual(self.downloader.config.output_dir, self.temp_dir)
    ...
    def test_get_video_info(self):
        ...
        self.assertEqual(self.downloader.config.output_dir, self.temp_dir)
        self.assertEqual(self.downloader.config.max_concurrent_downloads, 3)
        self.assertEqual(self.downloader.config.retry_times, 3)
